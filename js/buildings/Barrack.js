...
(function() {
    ...
    var proto = BuildingBarrack.prototype;

    function BuildingBarrack(container) {

        this.buildingName = 'barrackBuilding';
        ...
        // 初始化训练士兵动作
        var spriteName = 'barrack_soldier';
    ...
    proto.harvest = function() {
        ...
        if(global.isMyHome){
            this._request(3, data.extradata, null, function(e){
                global.soundManager.playEffect("harvest_soldier.mp3");
            });
        }else{
            var soldierIcon = global.sceneMyZone.cityScene.getChildByName('barrackBuilding').getChildByName('soldierIcon');
    ...
    global.BuildingBarrack = BuildingBarrack;
